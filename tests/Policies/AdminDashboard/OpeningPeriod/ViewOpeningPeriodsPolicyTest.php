...
class ViewOpeningPeriodsPolicyTest extends TestCase
{
    public User $user;
    ...
    public function it_allows_if_user_has_manage_all_shelters_permission()
    {
        ...
        $this->assertGate('view', [OpeningPeriod::class, $this->shelter])->isAllowed();
    }
    ...
    public function it_denies_if_user_has_manage_shelter_permission_for_other_shelter()
    {
        ...
        $this->assertGate('view', [OpeningPeriod::class, $this->shelter])
            ->isDenied()
            ->withMessage(__('policies.admin_dashboard.opening_period.view.no_permission'))
