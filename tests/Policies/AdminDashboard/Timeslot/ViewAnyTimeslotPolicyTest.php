...
class ViewAnyTimeslotPolicyTest extends TestCase
{
    public User $user;
    ...
    public function it_allows_if_user_has_manage_all_shelters_permission()
    {
        ...
        $this->assertGate('viewAny', [Timeslot::class, $this->shelter])->isAllowed();
    }
    ...
    public function it_denies_if_user_has_manage_shelter_permission_for_other_shelter()
    {
        ...
        $this->assertGate('viewAny', [Timeslot::class, $this->shelter])
            ->isDenied()
            ->withMessage(__('policies.admin_dashboard.timeslot.view_any.no_permission'))
