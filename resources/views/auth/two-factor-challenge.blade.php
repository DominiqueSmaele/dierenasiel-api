<x-guest-layout>
    <x-authentication-card>
        ...
        <div x-data="{ recovery: false }">
            <div class="text-gray-600 mb-4 text-sm" x-show="! recovery">
                {{ __('Please confirm access to your account by entering the authentication code provided by your authenticator application.') }}
            </div>

            <div class="text-gray-600 mb-4 text-sm" x-cloak x-show="recovery">
            ...
            <form method="POST" action="{{ route('two-factor.login') }}">
                ...
                <div class="mt-4 flex items-center justify-end">
                    <button type="button" class="text-gray-600 hover:text-gray-900 cursor-pointer text-sm underline"
                        x-show="! recovery"
                        x-on:click="
                                        recovery = true;
