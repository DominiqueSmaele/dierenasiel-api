        ...
        <div :class="isCollapsed ? 'w-20' : 'w-80'" class="navigation flex flex-col justify-between px-4 py-8">
            <div>
                <div class="flex h-10 items-center justify-between gap-3 px-3">
                    <a href="{{ route('shelter.animals-overview', $shelter->id) }}" x-show="!isCollapsed" class="truncate font-highlight-sans text-2xl font-semibold text-white">{{ $shelter->name }}</a>
