...
class ViewAnimalPolicyTest extends TestCase
{
    public User $user;
    ...
    public function it_allows_if_user_has_manage_all_shelters_permission()
    {
        ...
        $this->assertGate('view', $this->animal)->isAllowed();
    }
    ...
    public function it_denies_if_user_has_manage_shelter_permission_for_other_shelter()
    {
        ...
        $this->assertGate('view', $this->animal)
            ->isDenied()
            ->withMessage(__('policies.admin_dashboard.animal.view.no_permission'))
