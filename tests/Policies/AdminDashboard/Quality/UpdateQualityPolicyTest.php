...
class UpdateQualityPolicyTest extends TestCase
{
    public User $user;
    ...
    public function it_allows_if_user_has_manage_all_shelters_permission()
    {
        ...
        $this->assertGate('update', $this->quality)->isAllowed();
    }
    ...
    public function it_denies_if_user_has_incorrect_permissions()
    {
        ...
        $this->assertGate('update', $this->quality)
            ->isDenied()
            ->withMessage(__('policies.admin_dashboard.quality.update.no_permission'))
